...
v = gU[2]
sig = CoefficientFunction((-gU[0],-gU[1]))
w = gV[2]
tau = CoefficientFunction((-gV[0],-gV[1]))

vo = gU.Other()[2]
sigo = CoefficientFunction((-gU.Other()[0],-gU.Other()[1]))
wo = gV.Other()[2]
tauo = CoefficientFunction((-gV.Other()[0],-gV.Other()[1]))

h = specialcf.mesh_size
n = specialcf.normal(3)
n_t = n[2]/Norm(n)
n_x = CoefficientFunction((n[0]/Norm(n),n[1]/Norm(n)))
