...
void ExportEmbTrefftz(py::module m)
{
    m.def("TrefftzEmbedding", [] (shared_ptr<ngfem::SumOfIntegrals> bf,
          ...
          py::arg("bf"), py::arg("fes"), py::arg("lf"), py::arg("eps")=10^-12, py::arg("test_fes")=nullptr, py::arg("tndof")=0);
    ...
    m.def("TrefftzEmbedding", [] (shared_ptr<ngfem::SumOfIntegrals> bf,
          ...
          py::arg("bf"), py::arg("fes"), py::arg("eps")=10^-12, py::arg("test_fes")=nullptr, py::arg("tndof")=0);
