...
namespace ngcomp
{
  ...
  public:
    ...
    SetOp (shared_ptr<SumOfIntegrals> bf, shared_ptr<SumOfIntegrals> trhs,
    ...
    ///  @param fes_test the test finite element space of `top`
    ///
    ///  @param cop left hand side of the conformity operation. Bilinear
    ...
    ///
    /// @throws std::invalid_argument if `top`, `cop`, or `crhs` are
    /// `null`.
    shared_ptr<BaseVector> SetOp (optional<const SumOfIntegrals> top,
