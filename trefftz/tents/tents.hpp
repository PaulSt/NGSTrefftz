...
public:
  ...
  double *time;   // global physical time at vertex, stored in
                  // NPConservationLaw::gftau
...
public:
  ...
  void
  GetTentData (Array<int> &tentdata, Array<float> &tenttimes, int &nlevels);
};
