      ...
      if (useqt)
        {
          ...
          // localwavespeedcfx =
          // localwavespeedcfx->Diff(MakeCoordinateCoefficientFunction(0).get(),
          // make_shared<ConstantCoefficientFunction>(1) );
          // }
          // localwavespeedcf =
          // localwavespeedcf->Diff(MakeCoordinateCoefficientFunction(1).get(),
          // make_shared<ConstantCoefficientFunction>(1) ); localwavespeedcfx =
          // localwavespeedcf;
          // }
