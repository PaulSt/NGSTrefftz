...
namespace ngfem
{
    ...
    template<>
    void MonomialFE<1> :: CalcDDSpecialShape (const SIMD_BaseMappedIntegrationRule & smir,
    ...
    template<>
    void MonomialFE<2> :: CalcDDSpecialShape (const SIMD_BaseMappedIntegrationRule & smir,
                                         BareSliceMatrix<SIMD<double>> dshape,
                                         BareSliceMatrix<SIMD<double>> wavespeed,
                                         BareSliceMatrix<SIMD<double>> mu) const
    {
    ...
    template<>
    void MonomialFE<1> :: CalcMappedDDShape (const BaseMappedIntegrationPoint & bmip,
    ...
    template<>
    void MonomialFE<2> :: CalcMappedDDShape (const BaseMappedIntegrationPoint & bmip,
                                                BareSliceMatrix<> hddshape) const
    {
