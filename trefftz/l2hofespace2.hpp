...
namespace ngcomp
{
  ...
  */
  ...
  public:
    ...
    GetFE (ElementId ei, Allocator &alloc) const override;
    ...
    // override;
    ///
    // virtual const FiniteElement & GetFacetFE (int fnr, LocalHeap & lh)
    // const;

    // virtual void GetDofRanges (ElementId ei, Array<IntRange> & dranges)
    // const;

    virtual void GetDofNrs (ElementId ei, Array<DofId> &dnums) const override;
    ///
    // virtual shared_ptr<Table<int>> CreateSmoothingBlocks (const Flags &
    // precflags) const override;
    ///

    // virtual void GetVertexDofNrs (int vnr, Array<DofId> & dnums) const
    // override; virtual void GetEdgeDofNrs (int ednr, Array<DofId> & dnums)
    // const override; virtual void GetFaceDofNrs (int fanr, Array<DofId> &
    // dnums) const override; virtual void GetInnerDofNrs (int elnr,
    // Array<DofId> & dnums) const override;
