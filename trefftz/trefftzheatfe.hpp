...
{
    template<int D>
    class TrefftzHeatFE : public ScalarMappedElement<D+1>
    {
        private:
            ELEMENT_TYPE eltype;
            int basistype;
        ...
        public:
            // TrefftzHeatFE();
            TrefftzHeatFE(int aord = 1, float ac = 1.0, Vec<D+1> aelcenter = 0, double aelsize = 1, ELEMENT_TYPE aeltype = ET_TRIG, int abasistype = 0);
    ...
    class TrefftzHeatBasis{
        public:
            ...
            static void TB_inner(int ord, Matrix<> &trefftzbasis, Vec<D+1, int> coeffnum, int basis, int dim, int &tracker, int basistype, double Heatspeed = 1.0);
    ...
    template<int D>
    class TrefftzHeatTestFE : public ScalarMappedElement<D+1>
    {
        private:
            ELEMENT_TYPE eltype;
            int basistype;
        ...
        public:
            TrefftzHeatTestFE(int aord = 1, float ac = 1.0, Vec<D+1> aelcenter = 0, double aelsize = 1, ELEMENT_TYPE aeltype = ET_TRIG, int abasistype = 0);
