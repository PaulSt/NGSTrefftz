...
namespace ngcomp
{
  ...
  L2HighOrderFESpace2 ::
  L2HighOrderFESpace2 (shared_ptr<MeshAccess> ama, const Flags & flags, bool parseflags)
    : FESpace (ama, flags)
  {
  ...
  shared_ptr<FESpace> L2HighOrderFESpace2 ::
  ...
  // const FiniteElement & L2HighOrderFESpace2 :: GetFE (int elnr, LocalHeap & lh) const
  // {
  //   try
  //     {
  ...
  const FiniteElement & L2HighOrderFESpace2 :: GetFacetFE (int fnr, LocalHeap & lh) const
  {
  ...
  // const FiniteElement & L2HighOrderFESpace2 :: GetSFE (int elnr, LocalHeap & lh) const
  // {
  ...
  void L2HighOrderFESpace2 :: GetDofRanges (ElementId ei, Array<IntRange> & dranges) const
  {
    dranges.SetSize(0);
  ...
  shared_ptr<Table<int>> L2HighOrderFESpace2 ::
  ...
  namespace l2hofespace_cpp
  {
    ...
    Init::Init()
    {
      ...
      GetFESpaceClasses().AddFESpace ("l22surf", L2SurfaceHighOrderFESpace::Create);
    }
